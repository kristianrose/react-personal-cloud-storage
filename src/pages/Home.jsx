...
export default function Dashboard() {
  return (
    <>
      <CentredContainer>
        <AuthHeader title="Easy access to your content" subtitle="Store files and folders from your mobile device, tablet, or computer" />
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="mt-6 flex w-full gap-4">
            <Link className="btn btn-primary grow" to="/login">
              Login
            </Link>

            <Link className="btn btn-primary grow" to="/signup">
              Sign Up
            </Link>
          </div>
        </div>
